...
RageUIv1.Settings = {
    ...
    Items = {
        ...
        Background = { Dictionary = "syncleak.ytd", Texture = "gradient_bgd", Y = 0, Width = 431 },
        Navigation = {
            Rectangle = { Width = 0, Height = 0 },
            Offset = 5,
            Arrows = { Dictionary = "syncleak.ytd", Texture = "shop_arrows_upanddown", X = 190, Y = -6, Width = 0, Height = 0 },
        },
        Description = {
            Bar = { Y = 4, Width = 431, Height = 4 },
            Background = { Dictionary = "syncleak.ytd", Texture = "gradient_bgd", Y = 4, Width = 431, Height = 30 },
    ...
    Panels = {
        ...
        Percentage = {
            Background = { Dictionary = "syncleak.ytd", Texture = "gradient_bgd", Y = 4, Width = 431, Height = 76 },
        ...
        if CurrentMenu() and (CurrentMenu.Display.Header) then
            ...
            if CurrentMenu.Sprite ~= nil then
                if CurrentMenu.Sprite.Dictionary ~= nil then
                    if CurrentMenu.Sprite.Dictionary == "syncleak.ytd" then
...
function RageUIv1.IsVisible(Menu, Items, Panels)
    if (RageUIv1.Visible(Menu)) and (UpdateOnscreenKeyboard() ~= 0) and (UpdateOnscreenKeyboard() ~= 3) then
        RageUIv1.Banner()
        RageUIv1.Subtitle()
        if (Items ~= nil) then
            Items()
