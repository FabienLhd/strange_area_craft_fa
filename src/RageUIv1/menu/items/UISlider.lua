...
local SettingsSlider = {
    ...
    LeftArrow = { Dictionary = "syncleaktu", Texture = "arrowleft", X = 235, Y = 11.5, Width = 15, Height = 15 },
    RightArrow = { Dictionary = "syncleaktu", Texture = "arrowright", X = 400, Y = 11.5, Width = 15, Height = 15 },
}

-- RageUIv1.Slider("Label", 1, 100, "Coucou", true, {}, true, {})
function RageUIv1.Slider(Label, ProgressStart, ProgressMax, Description, Divider, Style, Enabled, Actions)
