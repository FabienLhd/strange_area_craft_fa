...
---@param B number
---@param A number
---@return RageUIv1Menus
---@public

function RageUIv1.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.DescriptionHeight = RageUIv1.Settings.Items.Description.Background.Height
    Menu.X = X or 0
    Menu.Y = Y or 0
    Menu.Parent = nil
    Menu.WidthOffset = 99
    Menu.Open = false
    Menu.Controls = RageUIv1.Settings.Controls
    Menu.Index = 1
    Menu.Sprite = { Dictionary = TextureDictionary or "syncleak", Texture = TextureName or "interaction_bgd", Color = { R = R, G = G, B = B, A = A } }
    Menu.Rectangle = nil
    ...
    if Menu.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(Menu.Subtitle, Menu.X + RageUIv1.Settings.Items.Subtitle.Text.X, Menu.Y + RageUIv1.Settings.Items.Subtitle.Text.Y, 0, RageUIv1.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, RageUIv1.Settings.Items.Subtitle.Background.Width + Menu.WidthOffset)
    ...
    return setmetatable(Menu, RageUIv1.Menus)
end
...
---@return RageUIv1Menus
---@public
function RageUIv1.CreateSubMenu(ParentMenu, Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    if ParentMenu ~= nil then
        if ParentMenu() then
            local Menu = RageUIv1.CreateMenu(Title or ParentMenu.Title, Subtitle or ParentMenu.Subtitle, X or ParentMenu.X, Y or ParentMenu.Y)
...
---@return nil
---@public
function RageUIv1.Menus:SetTitle(Title)
    self.Title = Title
end

function RageUIv1.Menus:SetStyleSize(Value)
    local witdh
...
---@return any
---@public
function RageUIv1.Menus:GetStyleSize()
...
---@return void
---@public
function RageUIv1.Menus:SetCursorStyle(Int)
...
---@return void
---@public
function RageUIv1.Menus:ResetCursorStyle()
    self.CursorStyle = 1
...
---@return void
---@public
function RageUIv1.Menus:UpdateCursorStyle()
...
---@return void
---@public
function RageUIv1.Menus:RefreshIndex()
    self.Index = 1
end
...
---@return nil
---@public
function RageUIv1.Menus:EditSpriteColor(R, G, B, A)
...
---@return nil
---@public
function RageUIv1.Menus:SetPosition(X, Y)
...
---@return nil
---@public
function RageUIv1.Menus:SetTotalItemsPerPage(Value)
...
---@return nil
---@public
function RageUIv1.Menus:SetRectangleBanner(R, G, B, A)
...
---@return nil
---@public
function RageUIv1.Menus:SetSpriteBanner(TextureDictionary, Texture)
    self.Sprite = { Dictionary = TextureDictionary or "syncleak", Texture = Texture or "interaction_bgd" }
    self.Rectangle = nil
end

function RageUIv1.Menus:Closable(boolean)
...
function RageUIv1.Menus:AddInstructionButton(button)
...
function RageUIv1.Menus:RemoveInstructionButton(button)
...
function RageUIv1.Menus:UpdateInstructionalButtons(Visible)
...
function RageUIv1.Menus:SetSizeWidth(Value)
    local witdh = 99
